$(document).ready(function() {
  ...
  var modalText = {
    discover: {
      ...
      tag: 'An app that allows neighbors to effectively communicate and share events, businesses and news.',
      detail:
        'Hood app is a platform that lets neighbors discover new local events and provides business owners access to target their market effectively within a residential area.',
      link: 'https://eat.chownow.com/'
    },
    ordering: {
      title: 'GoGreenKe',
      tag: 'Speed dail goods delivery company.',
      detail:
        'GoGreenKe is a zero carbon print goods delivery company that is committed to conserving the eco-system and healing the earth.',
      link: 'https://direct.chownow.com/direct/195/locations/260'
    },
    newrelic: {
      title: 'Homeboyzfc',
      tag: 'Semi-professional sports team.',
      detail:
        'Homeboyz is an entertainment company located in Nairobi, Kenya. It also sponsors a semi-pro rugby team that is one of the top rugby union teams in the country',
